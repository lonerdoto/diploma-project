    ...
    <div class="gap-5 gradient mx-auto py-5 px-10 text-white">
        ...
        <div class="flex py-10">
            ...
            <div class="flex flex-col gap-10 max-w-screen-sm">
                <div class="flex flex-col gap-5">
                    <h2>Схема проезда в Московский офис ЗАО «ФармФирма «Сотекс»</h2>
                        <img class="hover:scale-105 transition duration-300 rounded-2xl shadow-2xl" src="{{asset('images/map3.png')}}" alt="Image 1">
                    <p>115201, Москва, Каширское шоссе, д. 22, корп. 4, стр.7</p>
                </div>
                <div class="flex flex-col gap-5">
                    <h2>Схема проезда в коммерческий офис ЗАО «ФармФирма «Сотекс»</h2>
                    ...
                    <p>141345, Московская область, Сергиево-Посадский муниципальный район, сельское поселение
                        Березняковское, пос. Беликово, д. 11</p>
                </div>
            </div>
        </div>
