...
@section('content')
    ...
    <div class="container py-5 px-10 first-color mb-10">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white mb-6 rounded-lg">
            <div class="flex items-stretch gap-10">
                <div class="flex flex-col items-center gap-5 justify-center relative">
                    <label for="avatar"
                        ...
                        <img id="avatarPreview" alt="avatar"
                             ...
                             class="@if(auth()->id() === $user->id)  hover:scale-105 cursor-pointer @endif transition duration-300  w-44 h-44 shadow-xl rounded-full bg-white">
                        @if (auth()->id() === $user->id)
                ...
                <div class="flex flex-col justify-between">
                    <div>
                        ...
                        <a class="text-sm leading-normal mb-2 text-blueGray-400 font-bold uppercase" href="mailto:{{$user->email}}">
                   ...
                   <div class="flex gap-10 flex-wrap">
                       @if(auth()->user()->role === "admin")
                           <div class="mb-2 text-blueGray-600">
                               <p>Номер телефона: </p>
                               <span class="flex gap-3 items-center font-bold" id="phone-number">
                                @if(empty($user->phone))
                           ...
                           <div class="mb-2 text-blueGray-600">
                               ...
                               <span class="flex gap-3 items-center font-bold" id="director-name">
                           ...
                           <div class="mb-2 text-blueGray-600">
                               ...
                               <span class="flex gap-3 items-center font-bold" id="department">
                               ...
                               <form id="department-name-form" style="display: none;" class="inline" method="POST"
                       ...
                       @elseif(auth()->id() === $user->id)
                           ...
                           <div class="mb-2 text-blueGray-600">
                               <p>ФИО руководителя: </p>
                               <span class="flex gap-3 items-center font-bold">
                                {{ $user->{'director-name'} ?? 'Не указан' }}
                            </span>
                           </div>
                           <div class="mb-2 text-blueGray-600">
                               <p>Отдел сотрудника: </p>
                                ...
                                reader.onload = function (e) {
                                    ...
                                    fetch('{{ route('updateAvatar', ['id' => $user->id]) }}', {
                                        ...
                                        .then(data => {
                                            ...
                                            // Здесь можете добавить логику для обновления интерфейса, если требуется
                                        })
                                        .catch(error => {
                                            console.error('Error updating avatar:', error);
                                            // Здесь можете добавить логику для отображения ошибки пользователю
                                        });
                                };
