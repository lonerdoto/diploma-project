...
@section('content')
    <div class="mt-28 mb-10 mx-auto max-w-screen-2xl overflow-x-auto shadow-md sm:rounded-lg m-auto p-8 bg-gray-900">
        <div class="flex justify-between mb-10">
            <h1 class="mb-5 text-3xl font-normal text-gray-400">Записи диспетчера</h1>
        ...
        <form id="table-search-users" action="{{ route('dispatcherApplications') }}" method="GET"
            ...
            <div class="flex gap-3 items-center flex-wrap">
                ...
                <div class="relative">
                    ...
                    <input name="user-search" type="search" id="table-search-users"
                           class="block p-2 pl-10 text-sm border  rounded-lg w-80  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 transition duration-300"
                ...
                <div class="custom-select-wrapper">
                    <div class="relative custom-select rounded-xl">
                        ...
                        <div
                            class="custom-select-trigger py-2.5 px-5 text-sm font-medium focus:outline-none rounded-lg border focus:z-10 focus:ring-4 focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 transition duration-300">
                            По статусу заявки
                        </div>
                        <div
                            class="custom-options text-sm font-medium focus:outline-none bg-gray-700 focus:z-10 focus:ring-4 focus:ring-gray-700 text-gray-400 border-gray-600">
                            ...
                            @forelse($statuses as $status)
                                <span
                                    class="custom-option py-2.5 px-5 text-sm font-medium focus:outline-none rounded-lg  focus:z-10 focus:ring-4 focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 transition duration-300"
                                    id="{{$status->id}}"
            ...
            <div class="flex gap-3">
                <a data-modal-hide="popup-modal" href="{{ route('dispatcherApplications') }}"
                   class="py-2.5 px-5 text-sm font-medium  focus:outline-none  rounded-lg border    focus:z-10 focus:ring-4  focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 transition duration-300">Сброс</a>
                <button data-modal-hide="popup-modal" type="submit"
                        class="py-2.5 px-10 text-sm font-medium focus:outline-none  rounded-lg border  focus:z-10 focus:ring-4 focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 transition duration-300">
                    Найти...
                </button>
            </div>
           ...
           <div class="w-full flex justify-between items-center">
               <div class="flex gap-3 items-center">
                   ...
                   <input value="{{ $date_start }}" name="date-start" type="date" class="py-2.5 px-10 my-3 text-sm font-medium  focus:outline-none  rounded-lg border    focus:z-10 focus:ring-4  focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700">
               </div>
               <div class="flex gap-3 items-center">
                   <label class="text-gray-400" for="date-end">Дата до:</label>
                   <input value="{{ $date_end }}" name="date-end" type="date" class="py-2.5 px-10 my-3 text-sm font-medium  focus:outline-none  rounded-lg border    focus:z-10 focus:ring-4  focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700">
               </div>
           </div>
        </form>
        <table class="relative w-full text-sm text-left rtl:text-right text-gray-400 mt-4" id="data-table">
                    ...
                    @if(auth()->user()->role ==='admin')
                        <td class="px-6 py-4">
                            <details class="table-details">
                                ...
                                <button type="button"
                                        class="top-5 right-20 py-2.5 px-5 text-sm font-medium focus:outline-none  rounded-lg border   focus:z-10 focus:ring-4   focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-500 transition duration-300"
                                        name="edit" id="{{$dispatcherApplication->id}}">Редактировать
                                </button>
                                <button type="button"
                                        class="top-5 right-0 py-2.5 px-5 text-sm font-medium focus:outline-none  rounded-lg border   focus:z-10 focus:ring-4   focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-500 transition duration-300"
            ...
            @empty
                <tr class="border-b bg-gray-800 border-gray-700 hover:bg-gray-600">
                    <td colspan="12" class="px-6 py-4  whitespace-nowrap text-white">
