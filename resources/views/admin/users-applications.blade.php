...
@section('content')
    <div class="mt-28 mb-10 mx-auto max-w-screen-2xl overflow-x-auto shadow-md sm:rounded-lg m-auto p-8 bg-gray-900">
        <div class="flex justify-between mb-10">
            <h1 class="mb-5 text-3xl font-normal text-gray-400">Заявки сотрудников</h1>
                <div class="relative">
        ...
        <form id="table-search-users" action="{{ route('usersApplications') }}" method="GET"
                ...
                <div class="relative custom-select rounded-xl">
                    ...
                    <div class="custom-options text-sm font-medium text-gray-900 focus:outline-none bg-gray-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:border-gray-600">
                        ...
                        @forelse($applicationTypes as $applicationType)
                            <span
                                class="custom-option py-2.5 px-5 text-sm font-medium  focus:outline-none rounded-lg  focus:z-10 focus:ring-4 focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-500 transition duration-300"
            ...
            <div class="flex gap-3">
                <a data-modal-hide="popup-modal" href="{{ route('usersApplications') }}"
                   class="py-2.5 px-5 text-sm font-medium focus:outline-none  rounded-lg border   focus:z-10 focus:ring-4   focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-500 transition duration-300" >Сброс</a>
                <button data-modal-hide="popup-modal" type="submit"
                        class="py-2.5 px-5 text-sm font-medium focus:outline-none  rounded-lg border   focus:z-10 focus:ring-4   focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-500 transition duration-300">
                    Найти...
                </button>
            </div>
        </form>
